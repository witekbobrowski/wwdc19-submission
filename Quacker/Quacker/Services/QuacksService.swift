    ...
    func fetch() -> [Quack] {
        return [
            Quack(
                ...
                date: Date(timeInterval: -13, since: Date()),
                sentiment: Sentiment(value: 0.11),
                user: User.🤖
            ),
            Quack(
                ...
                date: Date(timeInterval: -500, since: Date()),
            ...
            Quack(
                ...
                date: Date(timeInterval: -32200, since: Date()),
                sentiment: Sentiment(value: 0.71),
                user: User.🐻
            ),
            Quack(
                ...
                date: Date(timeInterval: -90000, since: Date()),
                sentiment: Sentiment(value: 0.41),
                user: User.🦄
            )
        ]
    }
